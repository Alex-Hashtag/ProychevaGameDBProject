...
INSERT INTO CharacterKekkeiGenkai
    ...
    VALUES
        (@NarutoID, 1, TRUE, 'Master'),  -- Lava Release
        (@NarutoID, 2, TRUE, 'Master'),  -- Boil Release
        (@NarutoID, 3, TRUE, 'Master'),  -- Magnet Release
        (@NarutoID, 4, TRUE, 'Master'),  -- Ink Release
        (@NarutoID, 5, TRUE, 'Master'),  -- Blue Fire Release
        (@NarutoID, 6, TRUE, 'Master');  -- Steam Release
